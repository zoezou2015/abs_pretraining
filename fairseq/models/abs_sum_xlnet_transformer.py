...
@register_model('xlnet_transformer')
class AbsSumXLNetTransformerModel(FairseqModel):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--xlnet-model', default='xlnet-base-cased',
...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, segment_ids):
        ...
        # print(src_tokens)
        enc_hids, _ = self.xlnet(src_tokens, attention_mask=attention_mask)
...
@register_model_architecture('xlnet_transformer', 'abs_sum_xlnet_transformer_base')
...
@register_model_architecture('xlnet_transformer', 'abs_sum_xlnet_transformer')
def transformer_abs_sum_xlnet(args):
...
@register_model_architecture('xlnet_transformer', 'abs_sum_xlnet_transformer_medium')
def transformer_abs_sum_xlnet(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 768)

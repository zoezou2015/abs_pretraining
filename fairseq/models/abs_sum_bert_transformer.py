...
class AbsSumBertTransformerModel(FairseqModel):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--init-distributed', default=False, action='store_true',
                            help='decode mode, single gpu')
...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, segment_ids):
        ...
        segment_ids = segment_ids.view(bsz, seqlen)
        ...
        # print(src_tokens)
        enc_hids, _ = self.bert(src_tokens, token_type_ids=segment_ids, attention_mask=attention_mask)
...
@register_model_architecture('bert_transformer', 'abs_sum_bert_transformer_base')
...
@register_model_architecture('bert_transformer', 'abs_sum_bert_transformer')

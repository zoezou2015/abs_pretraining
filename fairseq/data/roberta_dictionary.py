...
class RobertaDictionary(Dictionary):
    ...
    def find_special_tokens(self):
        ...
        madeupword0001 50261
        madeupword0002 50261
        <mask> 50264
        '''
        self.pad_word = '<pad>'
    ...
    @classmethod
    def load_json(cls, f, ignore_utf_errors=False):
        """Loads the dictionary from a text file with the format:

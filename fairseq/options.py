...
def add_optimization_args(parser):
    ...
    group.add_argument("--param-name", type=str, default='encoder.bert', help='encoder.bert, encoder.roberta')
    group.add_argument('--sep-optim', action='store_true', help='Set different lr to encoder and decoder')
    group.add_argument('--dec-lr', default='0.25', type=eval_str_list,
                       metavar='LR_1,LR_2,...,LR_N',
...
def add_generation_args(parser):
    ...
    group.add_argument('--isRoberta', action='store_true',
                       help='if is roberta, call roberta_tokenizer.convert_tokens_to_string()')
    # fmt: on
    return group

...
@register_task('abstractive_summarization_roberta')
class AbstractiveSummarizationRobertaTask(FairseqTask):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--ensemble-pretrain', default=False, action='store_true',
    ...
    #
    #     task = AbstractiveSummarizationBertTask(args, src_dict, tgt_dict)
    ...
    def __init__(self, args, src_dict, tgt_dict):
        ...
        self.ensemble_pretrain = args.ensemble_pretrain
    @classmethod
    def setup_task(cls, args, **kwargs):
        ...
        # load dictionaries
        src_dict = RobertaDictionary.load(os.path.join(args.data[0], 'dict.{}.txt'.format(args.source_lang)))
        src_eos_idx = src_dict.eos()
        print('src_dict:[<|endoftext|>] id = {}, token = {}'.format(src_eos_idx, src_dict[src_eos_idx]))

        tgt_dict = RobertaDictionary.load(os.path.join(args.data[0], 'dict.{}.txt'.format(args.target_lang)))
        tgt_eos_idx = tgt_dict.eos()
        print('tgt_dict:[<|endoftext|>] id = {}, token = {}'.format(tgt_eos_idx, tgt_dict[tgt_eos_idx]))
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        self.datasets[split] = AbstractiveSumRobertaDataset(
            ...
            ensemble_pretrain=self.ensemble_pretrain,
        )

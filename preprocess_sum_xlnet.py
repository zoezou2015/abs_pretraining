...
from fairseq.data import indexed_dataset, xlnet_dictionary
...
def main(args):
    ...
    if args.joined_dictionary:
        ...
        if args.srcdict:
            ...
            print('load xlnet dict from {} | size {}'.format(args.srcdict, len(src_dict)))
        else:
            assert args.trainpref, "--trainpref must be set if --srcdict is not specified"
...
if __name__ == "__main__":
    ...
    save_vocab_path = 'xlnet-vocab/xlnet-base-cased-vocab.txt'
    load_wirte_xlnet_vocab(model_name, save_vocab_path)
    cli_main()
